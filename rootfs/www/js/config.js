...
const METRICS = {
  ...
  webboxChrgVtgBoost: {
    entity: pack('webbox_chrg_vtg_boost'),
    label: 'Boost charge V/cell',
    format: 'volts_cell',
    group: 'si',
  },
  webboxChrgVtgFul: {
    entity: pack('webbox_chrg_vtg_ful'),
    label: 'Full charge V/cell',
    format: 'volts_cell',
    group: 'si',
  },
  webboxChrgVtgEqu: {
    entity: pack('webbox_chrg_vtg_equ'),
    label: 'Equalize charge V/cell',
    format: 'volts_cell',
    group: 'si',
  },
  webboxChrgVtgFlo: {
    entity: pack('webbox_chrg_vtg_flo'),
    label: 'Float charge V/cell',
    format: 'volts_cell',
    group: 'si',
  },
  webboxBatVtgNom: {
    entity: pack('webbox_bat_vtg_nom'),
    label: 'Nominal battery V',
    format: 'volts',
    group: 'si',
  },
  webboxBatVtgMax: {
    entity: pack('webbox_bat_vtg_max'),
    label: 'Battery V max',
    format: 'volts',
    group: 'si',
  },
  webboxBatVtgMin: {
    entity: pack('webbox_bat_vtg_min'),
    label: 'Battery V min',
    format: 'volts',
    group: 'si',
  },
  webboxBatMinDchrgVtg: {
    entity: pack('webbox_bat_min_dchrg_vtg'),
    label: 'Min discharge V',
    format: 'volts',
    group: 'si',
  },
  webboxBatChrgVtgSimMan: {
    entity: pack('webbox_bat_chrg_vtg_sim_man'),
    label: 'Sim/manual charge V',
    format: 'volts',
    group: 'si',
  },
  webboxBatChrgVtgMan: {
    entity: pack('webbox_bat_chrg_vtg_man'),
    label: 'Manual charge V (BMS timeout)',
    format: 'volts',
    group: 'si',
  },
  webboxBatChrgVtg: {
    entity: pack('webbox_bat_chrg_vtg'),
    label: 'Live charge V (BMS)',
    format: 'volts',
    group: 'si',
  },
...
const PARAM_CONTROLS = [
  ...
  {
    id: 'chrg_vtg_boost',
    title: 'Boost charge V/cell (ChrgVtgBoost)',
    group: 'VRLA charge voltages',
    metric: 'webboxChrgVtgBoost',
    kind: 'number',
    write: { parameter: 'chrg_vtg_boost' },
    min: 1.5,
    max: 2.7,
    step: 0.01,
    presets: [2.25, 2.4, 2.55],
  },
  {
    id: 'chrg_vtg_ful',
    title: 'Full charge V/cell (ChrgVtgFul)',
    group: 'VRLA charge voltages',
    metric: 'webboxChrgVtgFul',
    kind: 'number',
    write: { parameter: 'chrg_vtg_ful' },
    min: 1.5,
    max: 2.7,
    step: 0.01,
    presets: [2.4, 2.5],
  ...
  {
    id: 'chrg_vtg_equ',
    title: 'Equalize charge V/cell (ChrgVtgEqu)',
    group: 'VRLA charge voltages',
    metric: 'webboxChrgVtgEqu',
    kind: 'number',
    write: { parameter: 'chrg_vtg_equ' },
    min: 1.5,
    max: 2.7,
    step: 0.01,
    presets: [2.4, 2.5],
  ...
  {
    id: 'chrg_vtg_flo',
    title: 'Float charge V/cell (ChrgVtgFlo)',
    group: 'VRLA charge voltages',
    metric: 'webboxChrgVtgFlo',
    kind: 'number',
    write: { parameter: 'chrg_vtg_flo' },
    min: 1.4,
    max: 2.4,
    step: 0.01,
    presets: [2.25],
  },
  {
    ...
    group: 'VRLA charge voltages',
    metric: 'webboxBatVtgNom',
    kind: 'number',
    write: { parameter: 'bat_vtg_nom' },
    min: 40,
    max: 60,
    step: 0.1,
    presets: [45.6, 48],
  },
  {
    ...
    group: 'VRLA charge voltages',
    metric: 'webboxBatVtgMax',
    kind: 'number',
    write: { parameter: 'bat_vtg_max' },
    min: 1,
    max: 100,
    step: 0.1,
    presets: [48, 54],
  },
  {
    ...
    group: 'VRLA charge voltages',
    metric: 'webboxBatVtgMin',
    kind: 'number',
    write: { parameter: 'bat_vtg_min' },
    min: 1,
    max: 100,
    step: 0.1,
    presets: [42, 44, 48],
  ...
  {
    id: 'bat_min_dchrg_vtg',
    title: 'Min discharge V (BatMinDchrgVtg)',
    group: 'VRLA charge voltages',
    metric: 'webboxBatMinDchrgVtg',
    kind: 'number',
    write: { parameter: 'bat_min_dchrg_vtg' },
    min: 1,
    max: 100,
    step: 0.1,
    presets: [42, 44, 46],
  ...
  {
    id: 'bat_chrg_vtg_sim_man',
    title: 'Sim/manual charge V (BatChrgVtgSimMan)',
    group: 'VRLA charge voltages',
    metric: 'webboxBatChrgVtgSimMan',
    kind: 'number',
    write: { parameter: 'bat_chrg_vtg_sim_man' },
    min: 41,
    max: 63,
    step: 0.1,
    presets: [48, 54, 54.5],
  },
  {
    ...
    group: 'VRLA charge voltages',
    metric: 'webboxBatChrgVtgMan',
    kind: 'number',
    write: { parameter: 'bat_chrg_vtg_man' },
    min: 41,
    max: 63,
    step: 0.1,
    presets: [48, 54, 54.5],
