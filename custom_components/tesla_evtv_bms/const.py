...
WEBBOX_SENSOR_KEYS = (
    ...
    "webbox_charge_current_max",
    "webbox_inverter_charge_current_max",
    "webbox_charge_control",
    "webbox_auto_equalize",
    "webbox_absorption_time_boost",
    "webbox_absorption_time_equalize",
    "webbox_absorption_time_full",
    "webbox_battery_type",
    "webbox_battery_nominal_v",
    "webbox_battery_capacity_ah",
    "webbox_self_consumption_min",
    "webbox_silent_enable",
    "webbox_sleep_enable",
    "webbox_grid_current_nom",
    ...
    "webbox_feed_in_current",
    "webbox_cycle_time_equalize",
    "webbox_cycle_time_full",
    "webbox_battery_temp_max",
    "webbox_battery_fan_temp",
    "webbox_silent_time_float",
    "webbox_silent_time_max",
    ...
    "webbox_generator_current_nom",
    "webbox_generator_power_start",
    "webbox_generator_power_stop",
