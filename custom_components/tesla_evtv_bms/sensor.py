...
SENSOR_TYPES = {
    ...
    "webbox_device_key": "",
    "webbox_charge_mode": "",
    "webbox_charge_voltage": "V",
    "webbox_charge_voltage_full": "V",
    "webbox_charge_voltage_float": "V",
    "webbox_charge_voltage_boost": "V",
    "webbox_charge_voltage_equalize": "V",
    "webbox_charge_voltage_manual": "V",
    "webbox_charge_current_max": "A",
    "webbox_inverter_charge_current_max": "A",
    "webbox_charge_control": "",
    "webbox_auto_equalize": "",
    "webbox_absorption_time_boost": "min",
    "webbox_absorption_time_equalize": "h",
    "webbox_absorption_time_full": "h",
    "webbox_battery_type": "",
    "webbox_battery_nominal_v": "V",
    "webbox_battery_capacity_ah": "Ah",
    "webbox_self_consumption_min": "%",
    "webbox_silent_enable": "",
    "webbox_sleep_enable": "",
    "webbox_grid_current_nom": "A",
    "webbox_grid_voltage_min": "V",
    "webbox_grid_voltage_max": "V",
    "webbox_grid_mode": "",
    "webbox_feed_in_mode": "",
    "webbox_feed_in_soc_start": "%",
    "webbox_feed_in_soc_stop": "%",
    "webbox_feed_in_current": "A",
    "webbox_cycle_time_equalize": "d",
    "webbox_cycle_time_full": "d",
    "webbox_battery_temp_max": "°C",
    "webbox_battery_fan_temp": "°C",
    "webbox_silent_time_float": "h",
    "webbox_silent_time_max": "h",
    "webbox_self_consumption_inc": "",
    "webbox_afra_enable": "",
    "webbox_run_mode": "",
    "webbox_external_source": "",
    "webbox_cluster_config": "",
    "webbox_inverter_voltage_nom": "V",
    "webbox_inverter_frequency_nom": "Hz",
    "webbox_power_limit": "kW",
    "webbox_grid_frequency_nom": "Hz",
    "webbox_grid_frequency_min": "Hz",
    "webbox_grid_frequency_max": "Hz",
    "webbox_grid_power_enable": "",
    "webbox_grid_soc_enable": "",
    "webbox_generator_auto": "",
    "webbox_generator_current_nom": "A",
    "webbox_generator_power_start": "kW",
    "webbox_generator_power_stop": "kW",
    "webbox_generator_voltage_min": "V",
    "webbox_generator_voltage_max": "V",
    "webbox_fault_text": "",
}
...
ICON_MAP = {
    ...
    "webbox_charge_voltage": "mdi:sine-wave",
    "webbox_charge_voltage_full": "mdi:battery-charging-high",
    "webbox_charge_voltage_float": "mdi:battery-charging-medium",
    "webbox_charge_voltage_boost": "mdi:battery-charging",
    "webbox_charge_voltage_equalize": "mdi:battery-sync",
    "webbox_charge_voltage_manual": "mdi:car-battery",
    "webbox_charge_current_max": "mdi:current-dc",
    "webbox_inverter_charge_current_max": "mdi:current-ac",
    "webbox_charge_control": "mdi:tune",
    "webbox_auto_equalize": "mdi:battery-sync",
    "webbox_absorption_time_boost": "mdi:timer-outline",
    "webbox_absorption_time_equalize": "mdi:timer-outline",
    "webbox_absorption_time_full": "mdi:timer-outline",
    "webbox_battery_type": "mdi:car-battery",
    "webbox_battery_nominal_v": "mdi:sine-wave",
    "webbox_battery_capacity_ah": "mdi:battery",
    "webbox_self_consumption_min": "mdi:battery-arrow-down",
    "webbox_silent_enable": "mdi:volume-off",
    "webbox_sleep_enable": "mdi:sleep",
    "webbox_grid_current_nom": "mdi:current-ac",
    "webbox_grid_voltage_min": "mdi:sine-wave",
    "webbox_grid_voltage_max": "mdi:sine-wave",
    "webbox_grid_mode": "mdi:transmission-tower",
    "webbox_feed_in_mode": "mdi:transmission-tower-export",
    "webbox_feed_in_soc_start": "mdi:battery-high",
    "webbox_feed_in_soc_stop": "mdi:battery-low",
    "webbox_feed_in_current": "mdi:current-ac",
    "webbox_cycle_time_equalize": "mdi:calendar",
    "webbox_cycle_time_full": "mdi:calendar",
    "webbox_battery_temp_max": "mdi:thermometer-high",
    "webbox_battery_fan_temp": "mdi:fan",
    "webbox_silent_time_float": "mdi:timer-outline",
    "webbox_silent_time_max": "mdi:timer-outline",
    "webbox_self_consumption_inc": "mdi:home-battery",
    "webbox_afra_enable": "mdi:sine-wave",
    "webbox_run_mode": "mdi:play",
    "webbox_external_source": "mdi:transmission-tower",
    "webbox_cluster_config": "mdi:lan",
    "webbox_inverter_voltage_nom": "mdi:sine-wave",
    "webbox_inverter_frequency_nom": "mdi:sine-wave",
    "webbox_power_limit": "mdi:lightning-bolt",
    "webbox_grid_frequency_nom": "mdi:sine-wave",
    "webbox_grid_frequency_min": "mdi:sine-wave",
    "webbox_grid_frequency_max": "mdi:sine-wave",
    "webbox_grid_power_enable": "mdi:transmission-tower",
    "webbox_grid_soc_enable": "mdi:battery",
    "webbox_generator_auto": "mdi:engine",
    "webbox_generator_current_nom": "mdi:current-ac",
    "webbox_generator_power_start": "mdi:engine",
    "webbox_generator_power_stop": "mdi:engine-off",
    "webbox_generator_voltage_min": "mdi:sine-wave",
    "webbox_generator_voltage_max": "mdi:sine-wave",
...
_VOLTAGE_KEYS = frozenset(
    {
        ...
        "webbox_charge_voltage_float",
        "webbox_charge_voltage_boost",
        "webbox_charge_voltage_equalize",
        "webbox_charge_voltage_manual",
        "webbox_battery_nominal_v",
        "webbox_grid_voltage_min",
        "webbox_grid_voltage_max",
        "webbox_inverter_voltage_nom",
        "webbox_generator_voltage_min",
        "webbox_generator_voltage_max",
        "lowest_cell",
        "highest_cell",
        "average_cell",
        "cell_difference",
